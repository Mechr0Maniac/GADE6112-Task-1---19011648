    ...
    class Map
    {
        ...
        public void Generate()
        {
            for (int i = 0; i < numUnits; i++)
            {
                ...
                {
                    RangedUnit ru = new RangedUnit(r.Next(0, 20),r.Next(0, 20),100,1,5,20,i % 2 == 0 ? 1 : 0,"R");
                    units.Add(ru);
                }
            }
        }
        ...
        public void Display(GroupBox groupBox)
        {
            ...
            foreach (Unit u in units)
            {
                ...
                if (u is MeleeUnit)
                {
                    ...
                    b.Location = new Point(mu.PosX * 20, mu.PosY * 20);
                    b.Text = mu.Symbol;
                    if (mu.Faction == 0)
                    {
                ...
                else
                {
                    ...
                    b.Size = new Size(20, 20);
                    b.Location = new Point(ru.PosX * 20, ru.PosY * 20);
                    b.Text = ru.Symbol;
                    if (ru.Faction == 0)
                    {
                        b.ForeColor = Color.Red;
